...
public class menuPrincipal {
    ...
    public void mostrar() {
        while (true) { // bucle infinito hasta salir
            ...
            try {
                ...
                System.out.println("⚠️ Aukera baliogabea. Zenbaki bat idatzi.");
                continue;
            }
    ...
    private void cerrarSesion() {
        ...
        if (resp.equalsIgnoreCase("B")) {
            ...
            System.out.println("➡️ Saioarekin jarraitzen da.");
            return; // vuelve al menú
        } else {
            System.out.println("⚠️ Aukera baliogabea. Idatzi 'B' edo 'Ez'.");
        }
    }
}
